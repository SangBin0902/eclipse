		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<form action="/product/register" method="post" class="p-3" enctype="multipart/form-data">
					...
					<div class="mb-3">
						<label class="form-label">Product Name</label><input type="text" name="pname" class="form-control">
					</div>
					...
					<div class="mb-3">
						<label class="form-label">Image Files</label><input type="file" name="files" class="form-control" multiple="multiple">
					</div>
